...
void estadisticasNotas(){
	...
	cout << "\n\n\t"; colorTexto("ESTADÍSTICAS DE PONDERADO NOTAS", amarilloClaro); cout<<"\n";
	...
	if( cantNotas > 0){
	    ...
	    while (fread(&c, sizeof(Curso), 1, archivo)) {
	        ...
	        cout<<"\n\t- Promedio de "<<c.nombre<<": "<<c.promedio;
	    }
		...
		cout << "\n\t"; colorTextoFondo("No se encontraron notas registradas!", blancoBrillante, rojo); cout<<"\n";
	}
